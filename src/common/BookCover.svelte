...
<a href="#" class="book book--interctive book--variation-{book.variation} {isValidUrl(book.cover) ? "book--cover" : "book--no-cover"}" on:click={() => dispatch("book-select", {id: book.id})}>
    <span class="cover" style={isValidUrl(book.cover) ? "backround-image: url" + book.cover + ")" : ""}>
